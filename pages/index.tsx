...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: '  const developerInfo = {', type: 'variable' },
    { code: "    name: 'Sadiq Adam Ismail',", type: 'array-item' },
    { code: "    role: 'Full Stack Web Developer & Trainer',", type: 'array-item' },
    { code: "    bio: 'Empowering others through code and innovation'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
    { code: '  useEffect(() => {', type: 'nested-function' },
    {
  ...
  return (
    <div className={styles.heroLayout}>
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Sadiq <span className={styles.accentText}>Adam Ismail</span>
          </h1>

          <div className={styles.developerRole}>Full Stack Web Developer & Trainer</div>
